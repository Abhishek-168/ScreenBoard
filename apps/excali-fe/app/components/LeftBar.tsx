    ...
    return (
        <>
            <div className="w-20 h-screen bg-linear-to-b from-slate-900 to-slate-950 flex flex-col gap-2 items-center py-6 fixed border-r border-slate-800/50 backdrop-blur-sm">
                ...
                <button className="p-3 rounded-2xl cursor-pointer" title="Joined Rooms">
                    <svg className="w-6 h-6 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <button className="p-3 rounded-2xl cursor-pointer" title="Notifications">
                ...
                <button className="p-3 rounded-2xl mb-4 cursor-pointer" title="Settings">
                    <svg className="w-6 h-6 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
